...
const About: React.FC = () => {
    return (
        <section id="about" className="min-h-fit flex flex-col-reverse md:flex-row bg-barn_red p-10 py-7 text-white font-helvetica size-blockqoute ">
            <div className="w-full md:w-1/2 flex flex-col pt-4 md:pt-0 items-center text-center md:items-start md:text-start">
                <h1 className="font-bold font-cinzel text-3xl md:py-6">TRUSTED BY 10,000+ STUDENTS</h1>
                <p className="mt-4 text-lg w-full md:w-3/4 pb-6">
