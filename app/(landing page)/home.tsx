...
const Home: React.FC = () => {
    return (
        <section id="home" className="flex min-h-screen flex-col items-center px-12 py-16">
            <Image src='' alt='landing image' className="h-96  w-11/12 max-w-screen-2xl mt-0.5 mb-14 " />
            <div className="font-cinzel flex flex-col gap-2 p-0 max-w-screen-2xl text-xl items-center text-center">
                ...
                <Image src={hometxt} alt="home text" />
                <p className="my-4">
                    <i>
