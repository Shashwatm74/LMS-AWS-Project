    ...
    return (
        <section id="home" className="flex min-h-fit flex-col items-center px-12 py-12">
            ...
            <div className="font-cinzel flex flex-col gap-2 p-0 max-w-screen-2xl text-xl items-center text-center">
                <h4 className="text-barn_red font-normal size-5 w-80 font-cinzel p-7">WELCOME TO</h4>
                <Image src={hometxt} alt="home text" className="h-16" />
                <p className="my-2 font-helvetica">
                    <i>
                ...
                <Button className="rounded-none w-40 h-11 bg-barn_red font-helvetica size-blockquote hover:bg-red-900">ABOUT US</Button>
            </div>
        </section>
    )
}
